...
data = pd.read_csv("/Users/admin/NLP-CS-2385-1/Assignment1/FinalDataset.csv", converters={"Word": eval, "POS": eval, "Tag": eval})
...
#our POS Tagging Accuracy with Stanford POS Tagger: 0.3390